...
console.log(`${target === "pages" ? "Pages" : "Vercel"} static artifact gate passed: ${names.length} files, 24 decision-linked story scenes, 5 precisely hashed inline scripts, no APIs or external runtime dependencies.`);
